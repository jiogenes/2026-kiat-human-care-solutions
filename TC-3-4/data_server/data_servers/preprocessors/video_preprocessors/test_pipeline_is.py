...
from preprocessors.data.dataset import VideoDataset, ImageDataset
...
def run():
    video_dataset = VideoDataset("/data/kiat/mpii_videos_flatten", image_shape=(224, 224))
    image_dataset = ImageDataset("/data/imagenet/train", image_shape=(224, 224))
